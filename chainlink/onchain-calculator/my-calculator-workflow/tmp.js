...
var onCronTrigger = (runtime2) => {
  ...
  runtime2.log(`Write report transaction succeeded: ${txHashHex}`);
  runtime2.log(`View transaction at https://sepolia.etherscan.io/tx/${txHashHex}`);
  runtime2.log(`Workflow finished successfully! offchainValue: ${offchainValue}, onchainValue: ${onchainValue}, finalResult: ${finalResult}, txHash: ${txHashHex}`);
  return {
    finalResult,
    offchainValue,
    onchainValue,
